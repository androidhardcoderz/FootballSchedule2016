...
import com.footballschedule2016.logify.views.GameLayout;
 ...
 */
public class PreseasonWeeklyFragment extends Fragment {
    ...
    public PreseasonWeeklyFragment(){
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        weeklyGameLoader.execute(week);
    }

    class WeeklyGameLoader extends AsyncTask<Integer,Game,Void>{
        ...
        protected Void doInBackground(Integer... params) {
            ...
            try {
                scheduleParser.getWeeklyGames(new InputStreamConverter(context).convertInputStreamToString(
                        context.getAssets().open("preseason.json")),popGamesToScreen,week);
